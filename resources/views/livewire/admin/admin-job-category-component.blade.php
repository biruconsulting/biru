      ...
      <div class="card-header py-2">
        <div class="row">
          <div class="col-12 col-md-7 mt-2 d-flex justify-content-md-start justify-content-center">
            <p class="m-0 font-weight-bold text-primary">Job Category DataTable</p>
          </div>
            ...
            <tbody>
              @foreach ($job_categories as $job_category)
                ...
                <tr>
                  ...
                  <td>
                    <a href="#" class="btn btn-danger btn-icon-split"  wire:click.prevent="categoryDeleteConfirmation({{ $job_category->id }})">
                      <span class="icon text-white-50">
