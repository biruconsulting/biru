      ...
      <div class="card-header py-2">
        <div class="row">
          <div class="col-12 col-md-7 mt-2 d-flex justify-content-md-start justify-content-center">
            <p class="m-0 font-weight-bold text-primary">Property Category DataTable</p>
          </div>
          ...
          <table class="table table-hover table-bordered" width="100%" cellspacing="0">
            ...
            <tbody>
              @foreach ($property_categories as $property_category)
                ...
                <tr>
                  <td>{{ $property_category->id }}</td>
                  <td>{{ $property_category->name }}</td>
                  <td>
                    <a href="#" class="btn btn-danger btn-icon-split"  wire:click.prevent="categoryDeleteConfirmation({{ $property_category->id }})">
                      <span class="icon text-white-50">
