        ...
        <div class="container">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane pt-3 fade show active" id="seller_ad" role="tabpanel" aria-labelledby="seller_ad-tab">
                    ...
                    <div wire:ignore.self class="form-section">
                        <form class="row g-3" wire:submit.prevent="submitAd">
                            <h6>USER DETAILS</h6>
                            <hr>
                            ...
                            <div wire:ignore.self class="seller-general box">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" rows="3" name="ad_short_description" wire:model="ad_short_description" id="seller_general_short_description" placeholder="Thumbnail Short Description" required></textarea>
                                    </div>
                                    <div class="col-12">
                            ...
                            <div wire:ignore.self class="seller-properties box">
                                <div class="row g-3">
                                    <div class="col-md-6">
