                                    ...
                                    <div class="accordion-body">
                                        <div class="accordion-body">
                                            @foreach ($job_categories as $job_category)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="{{ $job_category->id }}" wire:model="selected_job_category" id="flexCheckJobCategory{{ $job_category->id }}">
                                                    <label class="form-check-label" for="flexCheckJobCategory{{ $job_category->id }}">
                                                        {{ $job_category->name }}
                                                    </label>
