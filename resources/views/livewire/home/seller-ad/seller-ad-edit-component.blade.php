<div>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">UPDATE SELLER ADVERTISEMENT</li>
    ...
    <div class="container">
        ...
        <div class="main-bar-header text-center mt-3">
            <b>UPDATE {{ strtoupper($seller_general_ad_title ?? $seller_property_ad_title ?? $seller_job_ad_title) }} ADVERTISEMENT</b>
        </div>
